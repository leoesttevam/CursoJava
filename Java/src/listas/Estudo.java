...
public class Estudo {
	...
	public static void main(String[] args) {
		...
		System.out.println("- - - - - - - - - - - - - - - -");
		//Remover elemento que começa com a letra M
		...
		//caso o elemento não existir ele vai retorna nulo.
		String name = list.stream().filter(x -> x.charAt(0) == 'J').findFirst().orElse(null);
		
		if(name == null) {
			System.out.println("Nome não encontrado ou não existe na lista");
		}else {
